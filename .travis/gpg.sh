...
gpg --verbose --keyserver keyserver.ubuntu.com --send-keys ${GPG_KEYNAME}
gpg --verbose --keyserver keys.openpgp.org --send-keys ${GPG_KEYNAME}
gpg --verbose --keyserver keys.gnupg.net --send-keys ${GPG_KEYNAME}
gpg --verbose --keyserver pool.sks-keyservers.net --send-keys ${GPG_KEYNAME}
...
while(true); do
  ...
  gpg --verbose --keyserver keyserver.ubuntu.com  --recv-keys ${GPG_KEYNAME} && break || sleep 30
  gpg --verbose --keyserver keys.openpgp.org  --recv-keys ${GPG_KEYNAME} && break || sleep 30
  gpg --verbose --keyserver keys.gnupg.net  --recv-keys ${GPG_KEYNAME} && break || sleep 30
  gpg --verbose --keyserver pool.sks-keyservers.net  --recv-keys ${GPG_KEYNAME} && break || sleep 30
done
